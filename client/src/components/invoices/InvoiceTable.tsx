...
import { ChevronLeft, ChevronRight, ExternalLink, FileText, Edit } from "lucide-react";
              ...
              invoices.map((invoice) => (
                <>
                  ...
                  >
                    ...
                    <TableCell>
                      {invoice.invoice_header.pdf_link && (
                        <a 
                          href={invoice.invoice_header.pdf_link} 
                          target="_blank" 
                  ...
                  {expandedRow === invoice.invoice_header.invoice_num && (
                    <TableRow>
